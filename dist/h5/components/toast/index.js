...
export default class AtToast extends AtComponent {
  ...
  render() {
    ...
    return _isOpened ? <View className={classNames('at-toast', this.props.className)}>
        ...
        <View className={bodyClass} style={customStyle} onClick={this.handleClick}>
          <View className="toast-body-content">
            {realImg ? <View className="toast-body-content__img">
                <Image className="toast-body-content__img-item" src={realImg} mode="scaleToFill" />
              </View> : null}
            {isRenderIcon && <View className="toast-body-content__icon">
                <Text className={iconClass} />
              </View>}
            {text && <View className="toast-body-content__info">
                <Text>{text}</Text>
              </View>}
          </View>
        </View>
