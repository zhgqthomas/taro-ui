...
var AtSearchBar = function (_AtComponent) {
  ...
  _createClass(AtSearchBar, [{
    ...
    value: function handleChange(e) {
      this.__triggerPropsFn("onChange", [null].concat([e.target.value, e].concat(Array.prototype.slice.call(arguments))));
    }
  }, {
    key: "handleClear",
    ...
    value: function handleActionClick(e) {
      this.__triggerPropsFn("onActionClick", [null].concat([e]));
    }
  }, {
    key: "_createData",
    value: function _createData() {
      ...
      var anonymousState__temp4 = (0, _index.internal_inline_style)(value.length ? 'visibility: hidden;' : 'visibility: visible;');
      var anonymousState__temp5 = (0, _index.internal_inline_style)(value.length ? 'display: flex;' : 'display: none;');
      var anonymousState__temp6 = (0, _index.internal_inline_style)(actionStyle);
...
Component(require('../../npm/@tarojs/taro-weapp/index.js').default.createComponent(AtSearchBar));