...
var AtToast = function (_AtComponent) {
  ...
  function AtToast() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = AtToast.__proto__ || Object.getPrototypeOf(AtToast)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["anonymousState__temp", "_isOpened", "hasMask", "bodyClass", "realImg", "isRenderIcon", "icon", "text", "className"], _this.handleClick = function () {
...
Component(require('../../npm/@tarojs/taro-weapp/index.js').default.createComponent(AtToast));