...
var AtModal = function (_AtComponent) {
  ...
  function AtModal() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = AtModal.__proto__ || Object.getPrototypeOf(AtModal)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["title", "content", "rootClass", "_$isRenderAction", "cancelText", "confirmText", "_isOpened", "children"], _this.close = function () {
      _this.setState({
        _isOpened: false
      }, _this.handleClose);
...
AtModal.$$events = ["handleTouchMove", "close", "handleCancel", "handleConfirm"];
...
Component(require('../../npm/@tarojs/taro-weapp/index.js').default.createComponent(AtModal));