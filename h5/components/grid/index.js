...
var _chunk2 = require("../../npm/lodash/chunk.js");
...
var _isObject2 = require("../../npm/lodash/isObject.js");
...
var AtGrid = function (_AtComponent) {
  ...
  function AtGrid() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = AtGrid.__proto__ || Object.getPrototypeOf(AtGrid)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["anonymousState__temp", "loopArray0", "data", "gridGroup", "className"], _this.handleClick = function (item, index, row) {
...
Component(require('../../npm/@tarojs/taro-weapp/index.js').default.createComponent(AtGrid));