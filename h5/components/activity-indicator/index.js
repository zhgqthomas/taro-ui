...
var AtActivityIndicator = function (_AtComponent) {
  ...
  function AtActivityIndicator() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = AtActivityIndicator.__proto__ || Object.getPrototypeOf(AtActivityIndicator)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["rootClass", "size", "color", "content"], _this.$$refs = [], _temp), _possibleConstructorReturn(_this, _ret);
  }
...
Component(require('../../npm/@tarojs/taro-weapp/index.js').default.createComponent(AtActivityIndicator));