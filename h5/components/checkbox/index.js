...
var AtCheckbox = function (_AtComponent) {
  ...
  function AtCheckbox() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = AtCheckbox.__proto__ || Object.getPrototypeOf(AtCheckbox)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["anonymousState__temp", "anonymousState__temp2", "loopArray0", "options"], _this.$$refs = [], _temp), _possibleConstructorReturn(_this, _ret);
  }
...
Component(require('../../npm/@tarojs/taro-weapp/index.js').default.createComponent(AtCheckbox));