...
var _initialiseProps = function _initialiseProps() {
  ...
  this.$usedState = ["rootClass", "iconInfo", "thumb", "note", "extraText", "extraThumb", "isSwitch", "disabled", "switchIsCheck", "arrow", "title"];
...
Component(require('../../../npm/@tarojs/taro-weapp/index.js').default.createComponent(AtListItem));