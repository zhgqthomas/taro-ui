...
var AtTimeline = function (_AtComponent) {
  ...
  function AtTimeline() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = AtTimeline.__proto__ || Object.getPrototypeOf(AtTimeline)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["anonymousState__temp", "anonymousState__temp2", "loopArray0", "items", "className"], _this.$$refs = [], _temp), _possibleConstructorReturn(_this, _ret);
  }
  ...
  _createClass(AtTimeline, [{
    ...
    value: function _createData() {
      ...
      var anonymousState__temp = (0, _index6.default)(rootClassName, rootClassObject, this.__props.className);
...
Component(require('../../npm/@tarojs/taro-weapp/index.js').default.createComponent(AtTimeline));