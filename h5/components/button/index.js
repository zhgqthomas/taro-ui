...
AtButton.$$events = ["onClick", "onSumit", "onReset", "onGetUserInfo", "onGetPhoneNumber", "onOpenSetting", "onError", "onContact"];
...
Component(require('../../npm/@tarojs/taro-weapp/index.js').default.createComponent(AtButton));