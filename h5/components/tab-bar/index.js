...
var AtTabBar = function (_AtComponent) {
  ...
  _createClass(AtTabBar, [{
    ...
    value: function _constructor() {
      _get(AtTabBar.prototype.__proto__ || Object.getPrototypeOf(AtTabBar.prototype), "_constructor", this).apply(this, arguments);
      this.state = {
        isIPhoneX: false
      };
    }
...
Component(require('../../npm/@tarojs/taro-weapp/index.js').default.createComponent(AtTabBar));