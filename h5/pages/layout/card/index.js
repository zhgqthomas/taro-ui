...
var CardPage = function (_Taro$Component) {
  ...
  function CardPage() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = CardPage.__proto__ || Object.getPrototypeOf(CardPage)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = [], _this.config = {
